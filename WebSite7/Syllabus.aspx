<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Syllabus.aspx.cs" Inherits="CS" %>
            ...
            <div id="dvGrid" style="padding: 0px; width: 1200px">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        ...
                        <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1300">
                            <tr>
                                <td style="width: 26.4%">
                                    Syllabus Name:<br />
                                ...
                                <td style="width: 9.2%" align="center">
